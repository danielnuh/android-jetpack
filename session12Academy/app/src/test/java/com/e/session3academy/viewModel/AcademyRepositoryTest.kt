...
import com.e.session3academy.FakeAcademyRepository
import com.e.session3academy.PagedListUtil
...
import com.e.session3academy.utils.LiveDataTestUtil
...
class AcademyRepositoryTest {
    ...
    fun getAllCourses() {
        ...
        `when`(local.getAllCourse()).thenReturn(dataSourceFactory)
