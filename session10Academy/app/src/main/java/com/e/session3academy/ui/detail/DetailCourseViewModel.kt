...
//    fun getCourse():LiveData<Resource<CourseWithModule>> = academyRepository.getCourseWithModules(courseId)
//
//    fun getModules():LiveData<Resource<List<ModuleEntity>>> = academyRepository.getAllModulesByCourse(courseId)
